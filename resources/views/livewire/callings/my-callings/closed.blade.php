                ...
                <table class="table table-hover card-table table-vcenter text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$dado->user->name}} - {{date('d/m/Y H:i:s',strtotime($dado->opened))}}</td>
                            <td>
                            ...
                            <td>
                                <div class="btn-list">
                                    ...
                                    @endif
                                    @if((!empty($dado->answered) && empty($dado->confirmed)) || (!empty($dado->confirmed) && $dado->confirmed='N'))
                                        <!--<button class='btn btn-warning' wire:click='reCalling'>
                                            <i class="fe fe-check"></i>&nbsp;Re-Atendido                            
                                        </button> -->
                                    @endif
                                </div>
                            </td>
